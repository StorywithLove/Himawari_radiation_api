...
def downloadhtp(utc_dt, save_dir):    
    """
        ...
        eg: 
            wget -O G:/lcx/tmp.nc ftp://{usr}:SP+wari8@ftp.ptree.jaxa.jp/pub/himawari/L2/PAR/021/202602/28/09/H09_20260228_0900_RFL021_FLDK.02801_02401.nc
            wget -P G:/lcx/ ftp://{usr}:{pwd}@ftp.ptree.jaxa.jp/pub/himawari/L2/PAR/021/202602/28/09/H09_20260228_0900_RFL021_FLDK.02801_02401.nc
        边界条件:
            文件延迟, 注意未更新文件下载反馈
    """
